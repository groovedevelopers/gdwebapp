...
@customElement('groovy-custom-rssbtn')
class main extends LitElement {
  ...
  settings(event){
    const btnClickEvent  =  new CustomEvent('rss-settings', {
  ...
  render() {
    return html`
      ...
      <button @click=${this.settings} src=${this.src} class=${`${this.size} ${this.btnType}`} >  Rss </button>
