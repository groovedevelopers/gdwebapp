...
@customElement('groovy-custom-snapchatbtn')
class main extends LitElement {
  ...
  settings(event){
    const btnClickEvent  =  new CustomEvent('snapchat-settings', {
  ...
  render() {
    return html`
      ...
      <button @click=${this.settings} src=${this.src} class=${`${this.size} ${this.btnType}`} >  Snapchat </button>
