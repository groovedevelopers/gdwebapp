...
@customElement('groovy-custom-flickrbtn')
class main extends LitElement {
  ...
  settings(event){
    const btnClickEvent  =  new CustomEvent('flickr-settings', {
  ...
  render() {
    return html`
      ...
      <button @click=${this.settings} class=${`${this.size} ${this.btnType}`} src=${this.src} >  Flickr </button>
