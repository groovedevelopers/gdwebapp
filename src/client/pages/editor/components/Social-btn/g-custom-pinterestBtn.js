...
@customElement('groovy-custom-pinterestbtn')
class main extends LitElement {
  ...
  settings(event){
    const btnClickEvent  =  new CustomEvent('pinterest-settings', {
  ...
  render() {
    return html`
      ...
      <button @click=${this.settings} src=${this.src} class=${`${this.size} ${this.btnType}`} >  Pinterest </button>
