...
@customElement('groovy-custom-linkedinbtn')
class main extends LitElement {
  ...
  settings(event){
    const btnClickEvent  =  new CustomEvent('linkedin-settings', {
  ...
  render() {
    return html`
      ...
      <button @click=${this.settings} src=${this.src} class=${`${this.size} ${this.btnType}`} >  Linkedin </button>
